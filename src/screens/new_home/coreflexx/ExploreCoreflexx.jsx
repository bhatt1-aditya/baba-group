...
const ExploreCoreflexx = () => {
  ...
  return (
    <section className="md:py-16 bg-white">
      <div className="md:px-6 lg:px-10 px-4 flex flex-col md:flex-row items-center justify-between">
        <div className="text-left mb-4 max-w-xl">
          ...
          <p className="text-gray-500 mb-6">
            Discover premium Walleex surfaces crafted for beauty, durability,
            and global style.
          </p>
      ...
      <div className="grid grid-cols-1 max-w-7xl px-4 md:px-10 lg:px-10 mx-auto md:grid-cols-3 gap-10">
